<?php /* Smarty version 2.6.14, created on 2014-07-09 11:35:32
         compiled from viewca/viewcorpac.tpl */ ?>
<!-- BEGIN Main Content -->
 <?php echo '
...
<table class="table table-advance" id="table1">
    ...
    <tbody>
    	<?php $_from = $this->_tpl_vars['viewcorpaction']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):

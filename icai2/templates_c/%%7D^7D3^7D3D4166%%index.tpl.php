<?php /* Smarty version 2.6.14, created on 2014-08-05 11:21:47
         compiled from viewca2/index.tpl */ ?>
<!-- BEGIN Main Content -->
...
" data-placement="top" data-trigger="hover" class="show-popover" href="#"><?php echo $this->_tpl_vars['point']['mnemonic']; ?>
            ...
            <td style="width:145px !important;">
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View Fields" href="index.php?module=viewca2&event=view&id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-zoom-in"></i></a>
                    
                    <?php if ($this->_tpl_vars['sessData']['User']['type'] == 1): ?>
                    
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=viewca2&event=edit&id=<?php echo $this->_tpl_vars['point']['id']; ?>

<?php /* Smarty version 2.6.14, created on 2014-12-29 18:33:14
         compiled from viewca/viewweeklyca.tpl */ ?>
<!-- BEGIN Main Content -->
 <?php echo '
...
<table class="table table-advance" id="table1">
    ...
    <tbody>
    	<?php $_from = $this->_tpl_vars['viewweeklyca']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" /></td>
            ...
            <td><?php echo $this->_tpl_vars['point']['mnemonic']; ?>
</td>

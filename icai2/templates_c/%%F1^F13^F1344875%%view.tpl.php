<?php /* Smarty version 2.6.14, created on 2015-08-06 09:40:48
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>User : <?php echo $this->_tpl_vars['viewdata']['0']['username']; ?>
</h3>
                            </div>
...
?>
        <?php if (! empty ( $this->_tpl_vars['point'] )): ?>
        <tr>
            <td><input type="checkbox" id="checkboxid"  name="checkboxid" value="<?php echo $this->_tpl_vars['point']['indexid']; ?>
" /></td>
...
"><i class="icon-zoom-in"></i></a>
                    ...
                    <a class="btn btn-small btn-danger show-tooltip" title="De-allocate" href="#" id="a1" onclick="confirmdelete(<?php echo $this->_tpl_vars['point']['indexid']; ?>

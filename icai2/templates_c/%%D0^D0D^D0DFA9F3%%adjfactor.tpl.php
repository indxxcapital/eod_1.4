<?php /* Smarty version 2.6.14, created on 2014-05-27 17:39:12
         compiled from caindex/adjfactor.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'field', 'caindex/adjfactor.tpl', 13, false),)), $this); ?>
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i>Submit Adjacent Factor for <?php echo $this->_tpl_vars['postData']['ticker']; ?>
...
index.php?module=caindex&event=view&id=<?php echo $_GET['indxx_id']; ?>
';">Back</button>
                                    </div>

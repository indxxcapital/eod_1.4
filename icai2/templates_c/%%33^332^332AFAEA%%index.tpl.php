<?php /* Smarty version 2.6.14, created on 2014-08-05 11:19:05
         compiled from casecurities2/index.tpl */ ?>
<!-- BEGIN Main Content -->
...
" /></td>
            ...
            <td style="width:145px !important;">
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View Corporate Actions" href="index.php?module=viewca2&event=index&ticker_id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-zoom-in"></i></a>
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=casecurities2&event=edit&id=<?php echo $this->_tpl_vars['point']['id']; ?>

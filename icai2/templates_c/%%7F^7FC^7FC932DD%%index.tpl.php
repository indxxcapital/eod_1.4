<?php /* Smarty version 2.6.14, created on 2014-08-01 14:05:25
         compiled from adjbenchmarkindex2/index.tpl */ ?>
<!-- BEGIN Main Content -->
...
assets/New/img/pattern3.png) repeat !important;">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                      <?php if ($this->_tpl_vars['sessData']['User']['type'] == 1): ?>  <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=adjbenchmarkindex&event=addNew"><i class="icon-plus"></i></a>
...
" /></td>
            ...
            <td style="width:145px !important;">
                <div class="btn-group">
                  ...
                  <?php if ($this->_tpl_vars['sessData']['User']['type'] == 1): ?>      <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=adjbenchmarkindex&event=edit&id=<?php echo $this->_tpl_vars['point']['id']; ?>

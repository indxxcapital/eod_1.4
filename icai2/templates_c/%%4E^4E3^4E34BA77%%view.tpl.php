<?php /* Smarty version 2.6.14, created on 2014-04-24 11:50:26
         compiled from commodityindxxtemp/view.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'commodityindxxtemp/view.tpl', 67, false),)), $this); ?>
<!-- BEGIN Main Content -->
...
?>
 ...
 <?php if ($this->_tpl_vars['indxxdata']['0']['status'] != 1): ?>
  <a href="index.php?module=commodityindxxtemp&event=approve&id=<?php echo $this->_tpl_vars['indxxdata']['0']['id']; ?>
"><button class="btn btn-primary">Approve</button></a>
                                   
 <?php endif; ?>
 
 
   <a href="index.php?module=commodityindxxtemp&event=delete&id=<?php echo $this->_tpl_vars['indxxdata']['0']['id']; ?>

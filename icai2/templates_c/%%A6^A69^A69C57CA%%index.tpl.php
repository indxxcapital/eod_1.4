<?php /* Smarty version 2.6.14, created on 2014-08-01 13:30:37
         compiled from caupcomingindex2/index.tpl */ ?>
<!-- BEGIN Main Content -->
...
" /></td>
            ...
            <td>
                <div class="btn-group" style="width:145px !important;">
                    ...
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=caindex2&event=viewupcoming&id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-zoom-in"></i></a>
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=caupcomingindex2&event=editfornext&id=<?php echo $this->_tpl_vars['point']['id']; ?>
...
-->
       ...
       <!-- 
       <a class="btn btn-small show-tooltip" title="CalcShare" href="index.php?module=caindex2&event=calcshare&id=<?php echo $this->_tpl_vars['point']['id']; ?>

<?php /* Smarty version 2.6.14, created on 2014-08-11 16:55:48
         compiled from issuetrack/index.tpl */ ?>
<!-- BEGIN Main Content -->
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                       <?php if ($this->_tpl_vars['sessData']['User']['type'] != 4): ?>   <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=issuetrack&event=addNew"><i class="icon-plus"></i></a>
...
" /></td>
            ...
            <td>
                <div class="btn-group">
                <a class="btn btn-small show-tooltip" title="View" href="index.php?module=issuetrack&event=view&id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-zoom-in"></i></a>
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=issuetrack&event=edit&id=<?php echo $this->_tpl_vars['point']['id']; ?>

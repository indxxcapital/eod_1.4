<?php /* Smarty version 2.6.14, created on 2014-12-30 14:42:09
         compiled from holidays/index.tpl */ ?>
<!-- BEGIN Main Content -->
...
<table class="table table-advance" id="table1">
    ...
    <tbody>
    	<?php $_from = $this->_tpl_vars['holidaydata']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" /></td>
            <td><?php echo $this->_tpl_vars['point']['title']; ?>
             ...
             <td><?php echo $this->_tpl_vars['point']['zonename']; ?>
</td>       
...
"><i class="icon-zoom-in"></i></a>-->
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=holidays&event=edit&id=<?php echo $this->_tpl_vars['point']['id']; ?>

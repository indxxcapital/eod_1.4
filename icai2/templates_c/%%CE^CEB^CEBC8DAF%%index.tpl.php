                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                      <?php if ($this->_tpl_vars['sessData']['User']['type'] == 1): ?>  <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=benchmarkindex&event=addNew"><i class="icon-plus"></i></a>
...
" /></td>
            ...
            <td>
                <div class="btn-group">
                  ...
                  <?php if ($this->_tpl_vars['sessData']['User']['type'] == 1): ?>      <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=benchmarkindex&event=edit&id=<?php echo $this->_tpl_vars['point']['id']; ?>

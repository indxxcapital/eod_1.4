...
<!--            <td><a data-original-title="{$point.mnemonic}" data-content="{$sessData.variable[$point.mnemonic]}" data-placement="top" data-trigger="hover" class="show-popover" href="#">{$point.mnemonic}</a></td>-->
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View Fields" href="index.php?module=viewca&event=view&id={$point.id}"><i class="icon-zoom-in"></i></a>
                    
                    {if $sessData.User.type==1}
                    
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=viewca&event=edit&id={$point.id}"><i class="icon-edit"></i></a>

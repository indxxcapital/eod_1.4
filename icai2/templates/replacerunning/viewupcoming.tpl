...
<div class="row-fluid">
        ...
        {/foreach}
                                ...
                                <div class="clearfix"></div>
                                 <div class="box">
                                 <div class="box-title">
                                <h3><i class="icon-table"></i>Total {$total1} securities to be replaced</h3>
                            </div>
                              </div>  
...
<table class="table table-advance">
    ...
    {if $securitytobereplaced|@count>0}
    	{foreach from=$securitytobereplaced item=point key=k}
        <tr>
...
<div class="clearfix"></div>
                                 <div class="box">
                                 <div class="box-title">
                                <h3><i class="icon-table"></i>Total {$total2} securities added to replace</h3>
                            </div>
                              </div>  
